...
<head>
    ...
    <meta name="description" content="500 - Internal Server Error - CodeIgniter Alternative Framework">
    <link rel="icon" href="favicon.ico" type="image/png">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <title>500 - Internal Server Error | CodeIgniter Alternative</title>
    <style>
        :root {
            --ci-primary: #dd4814;
            --ci-primary-dark: #bf3c10;
            --ci-danger: #dc3545;
            --ci-danger-dark: #c82333;
            --ci-light: #f8f9fa;
            --ci-dark: #212529;
            --ci-border: #dee2e6;
            --ci-bg: #ffffff;
        ...
        * {
        ...
        .btn-primary:hover {
            background: var(--ci-danger-dark);
            border-color: var(--ci-danger-dark);
    ...
    <div class="error-container">
        ...
        <div class="error-content">
            ...
            <p class="error-message">
                ...
                from fulfilling the request. Our technical team has been notified 
...
Error: Internal Server Error - The server encountered an unexpected condition.</pre>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('%c🚨 500 - Internal Server Error', 'color: #dc3545; font-size: 16px; font-weight: bold;');
            console.log('%cThe server encountered an unexpected condition.', 'color: #6c757d;');
            console.log('%cOur technical team has been notified.', 'color: #6c757d;');
        });
    </script>
</body>
</html>