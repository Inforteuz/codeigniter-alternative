...
<body>
    <div class="container">
        ...
        <div class="error-title">400 - Bad Request</div>
        <p class="error-message">
            Oops! The request could not be understood by the server due to malformed syntax. Please check your input or contact support.
        </p>
